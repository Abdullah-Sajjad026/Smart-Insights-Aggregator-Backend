...
namespace SmartInsights.Infrastructure.Migrations
{
    ...
    [Migration("20251204184620_AddTopicStatusAndUpdates")]
    partial class AddTopicStatusAndUpdates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartInsights.Domain.Entities.Faculty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartInsights.Domain.Entities.InquiryFaculty", b =>
                {
                    b.Property<Guid>("InquiryId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("InquiryId", "FacultyId");

                    b.HasIndex("FacultyId");

                    b.ToTable("InquiryFaculties");
                });
            ...
            modelBuilder.Entity("SmartInsights.Domain.Entities.TopicUpdate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartInsights.Domain.Entities.Department", b =>
                {
                    b.HasOne("SmartInsights.Domain.Entities.Faculty", "Faculty")
